          ...
          <form onSubmit={addStaff}>
            ...
            <div>
              ...
              <input
                ...
                maxLength={10}
                onChange={(e) => {
                  setStaffDetails({ ...staffDetails, contact: e.target.value });
                }}
              />
            </div>
            <div>
              ...
              <input
                ...
                name="dob"
                onChange={(e) => {
                  setStaffDetails({ ...staffDetails, dob: e.target.value });
                }}
              />
            </div>
            <div>
              ...
              <select
                name="gender"
                onChange={(e) => {
                  setStaffDetails({ ...staffDetails, gender: e.target.value });
                }}
              >
            ...
            <div>
              ...
              <input
                ...
                name="address"
                onChange={(e) => {
                  setStaffDetails({ ...staffDetails, address: e.target.value });
                }}
              />
            </div>
            <div>
            ...
            <div>
              ...
              <input
                ...
                name="cash"
                onChange={(e) => {
                  setStaffDetails({ ...staffDetails, cash: e.target.value });
                }}
              />
            </div>
            <div>
              ...
              <select
                name="status"
                onChange={(e) => {
                  setStaffDetails({ ...staffDetails, status: e.target.value });
                }}
              >
                <option value="">--Options--</option>
